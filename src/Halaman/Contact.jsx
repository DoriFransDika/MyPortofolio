...
import SectionContainer from '../component/Selection/SectionContainer.jsx'; // Ensure SectionContainer is created
    ...
    const Contact = () => {
    // Inisialisasi Formspree dengan ID form Anda
    const [state, handleSubmit] = useForm("xkgzjlbw"); // GANTI "meozabob" dengan ID form Formspree Anda yang sebenarnya
    ...
    if (state.succeeded) {
        ...
        <section className="py-24 sm:py-32 bg-navy-dark text-white relative overflow-hidden min-h-screen flex items-center justify-center">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-tight">Thank You!</h2>
    ...
    return (
        ...
        <section className="py-24 sm:py-9  bg-navy-dark text-white relative overflow-hidden">
        <SectionContainer>
            ...
            <div className="w-full lg:w-1/2 space-y-8">
                {/* Info Kontak */}
                <div>
                <h3 className="text-xl md:text-2xl font-semibold text-white mb-4">Contact Info</h3>
                <div className="space-y-3">
                    <div className="flex items-center text-gray-300">
                    <i className="fas fa-envelope mr-3 text-soft-gold text-xl"></i>
                    <span>dorifransdikaa@gmail.com</span> {/* GANTI dengan email Anda */}
                    </div>
                    <div className="flex items-center text-gray-300">
