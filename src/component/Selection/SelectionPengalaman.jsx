import SectionContainer from './SectionContainer.jsx'; // Ensure SectionContainer is created
    ...
    const experienceData = [
        ...
        websiteLink: "https://www.komdigi.go.id/", // Updated Kominfo link
        },
        {
        id: 3,
        type: "Course",
      ...
      <SectionContainer>
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-700 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8 md:gap-x-12"> {/* MODIFIKASI DI SINI */}
