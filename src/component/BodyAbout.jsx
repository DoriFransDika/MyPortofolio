...
const BodyAbout = () => {
    ...
    return (
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            {/* Left Section: About Me Text Content */}
            ...
            {/* Right Section: Four Framed Photos (Custom/Random Layout) + Fifth Photo */}
            <div className="w-full lg:w-1/2 flex justify-center p-4">
            <div
                className="grid grid-cols-2 gap-6 w-full max-w-lg relative" // Increased gap slightly, added relative
            >
                {/* Photo 1: Slightly rotated, pushed slightly */}
                ...
                {/* Photo 2: Rotated opposite, pushed slightly */}
                <div className="relative w-full aspect-square rounded-lg overflow-hidden shadow-2xl border-4 border-white transform -rotate-2 -translate-x-1 translate-y-1 hover:scale-105 transition duration-300 ease-in-out animate__animated animate__zoomIn animate__delay-2s">
                <img
                    src="/image/9.jpg"
                ...
                {/* Photo 3: Rotated, pushed more vertically */}
                ...
                {/* Photo 4: Rotated opposite, pushed more vertically */}
                <div className="relative w-full aspect-square rounded-lg overflow-hidden shadow-2xl border-4 border-white transform -rotate-1 translate-x-1 -translate-y-2 hover:scale-105 transition duration-300 ease-in-out animate__animated animate__zoomIn animate__delay-4s">
                <img
                    src="/image/11.jpg"
                ...
                {/* Photo 5: The overlapping photo */}
                {/* Positioned absolutely, centered, slightly larger, and rotated */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 md:w-56 md:h-56 rounded-lg overflow-hidden shadow-2xl border-4 border-white transform rotate-3 hover:scale-110 transition duration-300 ease-in-out z-10 animate__animated animate__zoomIn animate__delay-5s"> {/* z-10 to ensure it's on top */}
                <img
                    src="/image/4.jpg" // GANTI dengan jalur foto kelima Anda
