// src/components/SelectionPendidikan.jsx
import React from 'react';
import SectionContainer from './SectionContainer.jsx'; // Ensure SectionContainer is created
  ...
  const educationData = [
    {
      ...
      logo: "/image/logo_itp.png", // REPLACE WITH YOUR ITP LOGO PATH
      mapsLink: "https://www.google.com/maps?ll=-0.899861,100.363257&z=16&t=m&hl=id&gl=ID&mapclient=embed&cid=8396328501859517192", // REPLACE WITH YOUR ITP GOOGLE MAPS LINK
      websiteLink: "https://www.itp.ac.id/", // REPLACE WITH YOUR ITP WEBSITE LINK
      instagramLink: "https://www.instagram.com/itp_official/", // ADD INSTAGRAM LINK IF AVAILABLE
    },
    {
      id: 2,
      years: "2018 - 2021",
      ...
      logo: "/image/12.jpeg", // REPLACE WITH YOUR SMA 2 LOGO PATH
      mapsLink: "https://www.google.co.id/maps/place/Senior+High+School+State+2+of+Sungai+Penuh/@-2.0758313,101.4017339,17z/data=!3m1!4b1!4m6!3m5!1s0x2e2da1a865f4a511:0xc82b5aaad755934c!8m2!3d-2.0758367!4d101.4043088!16s%2Fg%2F11bymyv7cd?entry=ttu", // REPLACE WITH YOUR SMA 2 GOOGLE MAPS LINK
      websiteLink: "https://sman2sungaipenuh.sch.id/", // REPLACE WITH YOUR SMA 2 WEBSITE LINK
      instagramLink: "https://www.instagram.com/sman2sp_official/", // ADD INSTAGRAM LINK IF AVAILABLE
    },
    {
      id: 3,
      years: "2015 - 2018",
      ...
      logo: "/image/smp2.jpg", // REPLACE WITH YOUR SMP 2 LOGO PATH
      mapsLink: "https://www.google.co.id/maps/place/Junior+High+School+State+2+of+Sungai+Penuh/@-2.0656838,101.3900369,17z/data=!3m1!4b1!4m6!3m5!1s0x2e2da1a67642f333:0x5839e8e794e60395!8m2!3d-2.0656892!4d101.3926118!16s%2Fg%2F1hm1r7kql?entry=ttu", // REPLACE WITH YOUR SMP 2 GOOGLE MAPS LINK
      instagramLink: "https://www.instagram.com/smpn2sungaipenuh/", // ADD INSTAGRAM LINK IF AVAILABLE
    },
    {
      id: 4,
      years: "2009 - 2015",
      ...
      logo: "/image/logo_sd.png", // REPLACE WITH YOUR SDN 004XI LOGO PATH
      mapsLink: "https://www.google.co.id/maps/place/SDN+004%2FXI+Sungai+Penuh/@-2.0657024,101.3881798,17z/data=!3m1!4b1!4m6!3m5!1s0x2e2da1aaf245397b:0x4319e71555d9fad!8m2!3d-2.0657078!4d101.3907547!16s%2Fg%2F11cjnnzhn2?entry=ttu", // REPLACE WITH YOUR SDN 004XI GOOGLE MAPS LINK
      instagramLink: "", // Add Instagram link if available, leave empty if not
    },
  ];

  return (
    <section className="py-24 sm:py-32 bg-pattern-white-abstract bg-cover bg-center bg-fixed text-white relative overflow-hidden"
        data-aos="fade-up"
        data-aos-duration="1000">
      <SectionContainer>
        {/* Header Section - Modified to match the new design */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8 md:gap-x-12">
          {educationData.map((item) => (
            ...
            >
              ...
              {/* Maps, Website, and Instagram Links */}
