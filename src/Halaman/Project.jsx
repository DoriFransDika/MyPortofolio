// src/Halaman/Project.jsx
import React from 'react';
import SectionContainer from '../component/Selection/SectionContainer.jsx'; // Ensure SectionContainer is created
...
const Project = () => {
  ...
  const projectData = [
    {
      ...
      image: "/image/nma.png", // REPLACE with your project image/thumbnail
      technologies: ["C#", "Windows Forms", "Database"], // Example technologies
      demoLink: "https://8kgkw7.csb.app/", // Link to live demo (if any)
    },
    {
      id: 2,
      ...
      image: "/image/cobar.png", // REPLACE with your project image/thumbnail
    ...
    },
    {
      ...
      image: "/image/rawn.png", // REPLACE with your project image/thumbnail
    ...
    },
    {
      ...
      image: "/image/spk.png", // REPLACE with your project image/thumbnail
    ...
    },
    {
      ...
      image: "/image/project-thumbnails/earthquake-map.jpg", // REPLACE with your project image/thumbnail
    ...
    },
    {
      ...
      image: "/image/project-thumbnails/article-manager.jpg", // REPLACE with your project image/thumbnail
  ...
  return (
    // Section background and text color match the overall theme
    <section className="py-24 sm:py-8 bg-navy-dark text-white relative overflow-hidden">
      <SectionContainer>
        {/* Header Section - Reusing the elegant pattern */}
