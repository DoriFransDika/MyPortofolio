...
const SelectionSkill = () => {
  ...
  return (
    ...
    <section className="py-24 sm:py-32 bg-navy-dark text-white relative overflow-hidden"
          data-aos="fade-up"
      ...
      <SectionContainer>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 md:gap-8">
          {skillData.map((skill) => (
            ...
            >
              {/* Removed generic icon. Only displaying text. */}
